...
STOCKS = {
    "hk": [
        ...
        ("hk01879", "01879", "曦智科技", "光电混合算力/光计算芯片", 2),
        # ── 电力基建 ──
        ("hk00836", "00836", "华润电力", "电力基建/发电", 3),
        ("hk01816", "01816", "中广核电力", "电力基建/发电", 3),
        ("hk03898", "03898", "时代电气", "电力基建/功率半导体", 2),
        ("hk02688", "02688", "新奥能源", "电力基建/天然气", 2),
    ],
    "ashare": [
        # 科创板/创业板/深交所/上交所
        # ── AI芯片/算力 ──
        ...
        ("sh603083", "603083", "剑桥科技", "光模块/交换机"),
        # ── AI服务器 ──
        ("sz000977", "000977", "浪潮信息", "AI服务器"),
        ("sh601138", "601138", "工业富联", "AI服务器"),
        ("sh603019", "603019", "中科曙光", "AI服务器"),
        # ── 存储 ──
        ("sz603986", "603986", "兆易创新", "存储芯片"),
        ("sz300223", "300223", "北京君正", "存储芯片"),
        # ── 半导体设备 ──
        ("sz002371", "002371", "北方华创", "半导体设备"),
        ("sh688012", "688012", "中微公司", "半导体设备"),
        ("sh688072", "688072", "拓荆科技", "半导体设备"),
        # ── 半导体材料 ──
        ("sz002318", "002318", "雅克科技", "半导体材料"),
        ("sh688188", "688188", "南大光电", "半导体材料"),
        ("sz002106", "002106", "鼎龙股份", "半导体材料"),
        ("sh603989", "603989", "江化微", "半导体材料"),
        # ── 先进封装 ──
        ("sh601986", "601986", "长电科技", "先进封装"),
        ("sz002156", "002156", "通富微电", "先进封装"),
        ("sz002185", "002185", "华天科技", "先进封装"),
        # ── 网络互连 ──
        ("sz301165", "301165", "锐捷网络", "网络互连"),
        # ── 电源/散热 ──
        ("sz002334", "002334", "英威腾", "电源/散热"),
        ("sz301018", "301018", "申菱环境", "电源/散热"),
        # ── AI应用 ──
        ("sz002230", "002230", "科大讯飞", "AI应用"),
        ("sz300418", "300418", "昆仑万维", "AI应用"),
        ("sh601360", "601360", "360集团", "AI安全"),
        # ── 电力基建（发电/输电/储电/用电） ──
        ("sh601985", "601985", "中国核电", "电力基建/发电"),
        ("sh600900", "600900", "长江电力", "电力基建/发电"),
        ("sh600406", "600406", "国电南瑞", "电力基建/输电"),
        ("sh600089", "600089", "特变电工", "电力基建/输电"),
        ("sh688676", "688676", "金盘科技", "电力基建/输电"),
        ("sz002364", "002364", "中恒电气", "电力基建/输电"),
        ("sz300750", "300750", "宁德时代", "电力基建/储电"),
        ("sz300274", "300274", "阳光电源", "电力基建/储电"),
        ("sz002335", "002335", "科华数据", "电力基建/用电"),
        ("sz002837", "002837", "英维克", "电力基建/用电"),
        ("sh600875", "600875", "东方电气", "电力基建/发电设备"),
    ],
    "us": [
        # ── AI GPU/算力 ──
        ...
        ("usMU", "MU", "美光科技", "存储/HBM"),
        # ── 半导体设备 ──
        ("usAMAT", "AMAT", "应用材料", "半导体设备"),
        ("usLRCX", "LRCX", "科林研发", "半导体设备"),
        ("usKLAC", "KLAC", "科磊", "半导体设备"),
        # ── 先进封装/代工 ──
        ("usTSM", "TSM", "台积电", "先进封装/代工"),
        # ── 网络互连 ──
        ("usCSCO", "CSCO", "思科", "网络互连"),
        # ── 电源/散热 ──
        ("usVRT", "VRT", "维谛技术", "电源/散热"),
        # ── AI应用 ──
        ...
        # ── 电力基建 ──
        ("usCEG", "CEG", "Constellation Energy", "电力基建/核电"),
        ("usVST", "VST", "Vistra Energy", "电力基建/核电"),
        ("usNEE", "NEE", "NextEra Energy", "电力基建/可再生"),
        ("usETN", "ETN", "Eaton Corporation", "电力基建/用电"),
        ("usPWR", "PWR", "Quanta Services", "电力基建/输电"),
    ]
}
